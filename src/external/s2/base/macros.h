...
// These macros previously specialized std::is_pod, which is undefined behavior
// and prohibited by Xcode 26.4's libc++. s2 does not internally rely on these
// declarations, so they are now no-ops.
// See: https://github.com/realm/realm-core/commit/d8f21f9b98cae76e8dc235558c2f71ea27997f10
#define DECLARE_POD(TypeName)
#define DECLARE_NESTED_POD(TypeName)
